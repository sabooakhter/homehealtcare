...
INSERT INTO patients (id, name, age, address, city, state, zip, phone) VALUES
  ('f6a7b8c9-d0e1-9f0a-3b4c-5d6e7f8a9b0', 'Eleanor Thompson', 78, '123 Main St, Apt 4B', 'New York', 'NY', '10001', '(555) 123-4567'),
  ('a7b8c9d0-e1f2-0a1b-4c5d-6e7f8a9b0c1', 'Robert Johnson', 65, '456 Park Ave', 'New York', 'NY', '10002', '(555) 234-5678'),
...
INSERT INTO patient_conditions (patient_id, condition) VALUES
  ('f6a7b8c9-d0e1-9f0a-3b4c-5d6e7f8a9b0', 'Hypertension'),
  ('f6a7b8c9-d0e1-9f0a-3b4c-5d6e7f8a9b0', 'Arthritis'),
  ('f6a7b8c9-d0e1-9f0a-3b4c-5d6e7f8a9b0', 'Type 2 Diabetes'),
  ('a7b8c9d0-e1f2-0a1b-4c5d-6e7f8a9b0c1', 'COPD'),
  ('a7b8c9d0-e1f2-0a1b-4c5d-6e7f8a9b0c1', 'Heart Disease'),
...
INSERT INTO patient_caregivers (patient_id, caregiver_id) VALUES
  ('f6a7b8c9-d0e1-9f0a-3b4c-5d6e7f8a9b0', 'a1b2c3d4-e5f6-4a5b-8c9d-0e1f2a3b4c5d'),
  ('f6a7b8c9-d0e1-9f0a-3b4c-5d6e7f8a9b0', 'b2c3d4e5-f6a7-5b6c-9d0e-1f2a3b4c5d6e'),
  ('a7b8c9d0-e1f2-0a1b-4c5d-6e7f8a9b0c1', 'b2c3d4e5-f6a7-5b6c-9d0e-1f2a3b4c5d6e'),
...
INSERT INTO tasks (patient_id, caregiver_id, title, type, scheduled_at, duration, notes, completed) VALUES
  ('f6a7b8c9-d0e1-9f0a-3b4c-5d6e7f8a9b0', 'a1b2c3d4-e5f6-4a5b-8c9d-0e1f2a3b4c5d', 'Morning Medication', 'medication', now() + interval '1 hour', 15, 'Administer blood pressure medication', false),
  ('f6a7b8c9-d0e1-9f0a-3b4c-5d6e7f8a9b0', 'a1b2c3d4-e5f6-4a5b-8c9d-0e1f2a3b4c5d', 'Routine Check', 'visit', now() + interval '3 hours', 60, NULL, false),
  ('a7b8c9d0-e1f2-0a1b-4c5d-6e7f8a9b0c1', 'b2c3d4e5-f6a7-5b6c-9d0e-1f2a3b4c5d6e', 'Physical Therapy Session', 'therapy', now() + interval '5 hours', 45, 'Focus on mobility exercises', false),
